    ...
    return (
        <div className="relative rounded-xl overflow-hidden bg-black aspect-[3/4] flex flex-col">
            ...
            <div className="absolute top-4 inset-x-0 z-20 text-center">
                <p className="text-white text-sm font-medium drop-shadow-md bg-black/40 inline-block px-3 py-1 rounded-full"> Align your face in the oval </p>
            </div>
            <div className="absolute bottom-6 inset-x-0 z-20 flex justify-center">
                <button onClick={takeSnapshot} className="h-16 w-16 rounded-full bg-white/30 border-4 border-white flex items-center justify-center hover:bg-white/50 transition-colors" aria-label="Take Photo" >
